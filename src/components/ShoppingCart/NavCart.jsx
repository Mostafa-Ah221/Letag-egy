  ...
  return (
    <nav className="bg-Neutral p-4 rounded">
      <ul className="flex space-x-4">
        <li><Link to="/cartlayout/" className="text-slate-800 hover:text-primary duration-200">العنوان</Link></li>
        ...
        <li><Link to="/cartlayout/review" className="text-slate-800 hover:text-primary duration-200">مراجعة</Link></li>
      </ul>
    </nav>
  );
}
