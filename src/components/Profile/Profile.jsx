    ...
    <>
      <div className='my-16'>
        ...
        <div className='flex flex-row-reverse'>
          <div className='container flex flex-col w-96 bg-white shadow-lg rounded-lg mt-12'>
          ...
          <div className='flex flex-col w-52 rounded-lg'>
          ...
          <div className='flex flex-col w-52 mx-2 rounded-lg'>
